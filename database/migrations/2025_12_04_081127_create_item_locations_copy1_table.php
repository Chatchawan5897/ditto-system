...
return new class extends Migration
{
    ...
    {
        Schema::create('item_locations_copy1', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('item_id');
            $table->bigInteger('location_id')->nullable();
            $table->bigInteger('doc_head_id');
            $table->string('doc_head_type');
    ...
    {
        Schema::dropIfExists('item_locations_copy1');
    }
};
