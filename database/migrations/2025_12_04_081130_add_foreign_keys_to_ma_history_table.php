...
return new class extends Migration
{
    ...
    {
        Schema::table('ma_history', function (Blueprint $table) {
    ...
    {
        Schema::table('ma_history', function (Blueprint $table) {
            $table->dropForeign('ma_history_created_by_foreign');
            $table->dropForeign('ma_history_deleted_by_foreign');
            $table->dropForeign('ma_history_ma_item_id_foreign');
            $table->dropForeign('ma_history_updated_by_foreign');
        });
    }
};
