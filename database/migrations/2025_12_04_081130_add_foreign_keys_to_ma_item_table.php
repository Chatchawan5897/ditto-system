...
return new class extends Migration
{
    ...
    {
        Schema::table('ma_item', function (Blueprint $table) {
    ...
    {
        Schema::table('ma_item', function (Blueprint $table) {
            $table->dropForeign('ma_item_created_by_foreign');
            $table->dropForeign('ma_item_deleted_by_foreign');
            $table->dropForeign('ma_item_updated_by_foreign');
        });
    }
};
